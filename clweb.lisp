...
(DEFUN TANGLE-FILE
  ...
  (MULTIPLE-VALUE-BIND (OUTPUT-FILE LISP-FILE TESTS-OUTPUT-FILE TESTS-FILE)
    ...
    (LET* ((*TANGLE-FILE-PATHNAME* INPUT-FILE)
      ...
      (TANGLE-SECTIONS *SECTIONS* :INPUT-FILE INPUT-FILE :OUTPUT-FILE LISP-FILE
                       :IF-EXISTS IF-EXISTS :EXTERNAL-FORMAT EXTERNAL-FORMAT)
      ...
      (WHEN (AND TESTS-FILE (> (LENGTH *TEST-SECTIONS*) 1))
        ...
        (MULTIPLE-VALUE-BIND (OUTPUT-FILE INDEX-FILE SECTIONS-FILE)
          ...
          (WEAVE-SECTIONS *TEST-SECTIONS* :INPUT-FILE INPUT-FILE :OUTPUT-FILE
                          ...
                          :EXTERNAL-FORMAT EXTERNAL-FORMAT :WEAVING-TESTS T))))
...
(DEFINE-SPECIAL-FORM-WALKER #+:SBCL sb-int:named-lambda
    #-:SBCL named-lambda
  ((WALKER WALKER) FORM ENV &KEY TOPLEVEL)
  (DECLARE (IGNORE TOPLEVEL))
...
(DEFUN WALK-DEFSTRUCT-SLOT-DESCRIPTION
  ...
  (TYPECASE SLOT-DESCRIPTION
    ...
    (CONS
     (DESTRUCTURING-BIND
         (SLOT-NAME
          &OPTIONAL (INITFORM NIL INITFORM-SUPPLIED)
          &REST ARGS
