...
(DEFINE-CONDITION UNUSED-NAMED-SECTION-WARNING
    (SIMPLE-WARNING)
    NIL)
(DEFCLASS CLWEB-FILE (ASDF:SOURCE-FILE) ((TYPE :INITFORM "clw")))
...
(DEFMETHOD ASDF:PERFORM ((OP ASDF:COMPILE-OP) (COMPONENT CLWEB-FILE))
  (TANGLE-FILE (ASDF:COMPONENT-PATHNAME COMPONENT) :OUTPUT-FILE
...
(DEFCLASS WEAVE-OP (ASDF:OPERATION) NIL)
(DEFMETHOD ASDF:OUTPUT-FILES ((OP WEAVE-OP) (COMPONENT CLWEB-FILE))
  (VALUES
   (MULTIPLE-VALUE-LIST (WEAVE-PATHNAMES (ASDF:COMPONENT-PATHNAME COMPONENT)))
   T))
(DEFMETHOD ASDF:PERFORM ((OP WEAVE-OP) COMPONENT) (DECLARE (IGNORE COMPONENT)))
