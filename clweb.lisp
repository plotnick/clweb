      ...
      (COND
       ((AND TESTS-FILE (> (LENGTH *TEST-SECTIONS*) 1))
        ...
        (TANGLE-SECTIONS *TEST-SECTIONS* :INPUT-FILE INPUT-FILE :OUTPUT-FILE
                         TESTS-FILE :EXTERNAL-FORMAT EXTERNAL-FORMAT))
...
(DEFUN TANGLE-FILE-PATHNAMES
  ...
  (LET* ((INPUT-FILE
         ...
         (TESTS-OUTPUT-FILE
          (APPLY #'TESTS-FILE-PATHNAME OUTPUT-FILE
                 (PATHNAME-TYPE OUTPUT-FILE :CASE :COMMON) ARGS)))
  ...
  (MULTIPLE-VALUE-BIND (INPUT-FILE OUTPUT-FILE INDEX-FILE SECTIONS-FILE)
    ...
    (LET ((TESTS-FILE (APPLY #'TESTS-FILE-PATHNAME OUTPUT-FILE "TEX" ARGS)))
      (WHEN (AND TESTS-FILE (> (LENGTH *TEST-SECTIONS*) 1))
        ...
        (MULTIPLE-VALUE-BIND (INPUT-FILE OUTPUT-FILE INDEX-FILE SECTIONS-FILE)
            (APPLY #'WEAVE-FILE-PATHNAMES INPUT-FILE :OUTPUT-FILE TESTS-FILE
                   ARGS)
          (WHEN INDEX-FILE
    ...
    (WEAVE-SECTIONS *SECTIONS* :INPUT-FILE INPUT-FILE :OUTPUT-FILE OUTPUT-FILE
                    ...
                    EXTERNAL-FORMAT)))
(DEFUN WEAVE-FILE-PATHNAMES
       (INPUT-FILE
        &KEY OUTPUT-FILE (INDEX-FILE NIL INDEX-FILE-SUPPLIED)
        &ALLOW-OTHER-KEYS)
  (LET* ((INPUT-FILE
          (LET ((INPUT-FILE-TYPE (MAKE-PATHNAME :TYPE "CLW" :CASE :COMMON)))
            (MERGE-PATHNAMES INPUT-FILE INPUT-FILE-TYPE)))
         (OUTPUT-FILE
          (LET* ((OUTPUT-FILE-TYPE (MAKE-PATHNAME :TYPE "TEX" :CASE :COMMON))
            ...
            (IF OUTPUT-FILE
                ...
                OUTPUT-FILE-DEFAULTS)))
         (INDEX-FILE
          (LET* ((INDEX-FILE-TYPE (MAKE-PATHNAME :TYPE "IDX" :CASE :COMMON))
                 (INDEX-FILE-DEFAULTS
         ...
         (SECTIONS-FILE
          (LET ((SECTIONS-FILE-TYPE (MAKE-PATHNAME :TYPE "SCN" :CASE :COMMON)))
            (WHEN INDEX-FILE (MERGE-PATHNAMES SECTIONS-FILE-TYPE INDEX-FILE)))))
