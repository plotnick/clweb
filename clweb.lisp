...
(DEFUN TESTS-FILE-PATHNAME
  ...
  (IF TESTS-FILE
      ...
      (UNLESS TESTS-FILE-SUPPLIED
        (MERGE-PATHNAMES
         (MAKE-PATHNAME :HOST (PATHNAME-HOST OUTPUT-FILE) :NAME
                        (CONCATENATE 'STRING
...
(DEFUN TANGLE-FILE-PATHNAMES
  ...
  (LET* ((INPUT-FILE
         ...
         (LISP-FILE
          (MERGE-PATHNAMES
           (MAKE-PATHNAME :HOST (PATHNAME-HOST OUTPUT-FILE) :TYPE "LISP" :CASE
                          :COMMON)
           OUTPUT-FILE))
         (TESTS-FILE
         ...
         (TESTS-OUTPUT-FILE
          (WHEN TESTS-FILE
            (MERGE-PATHNAMES
             (MAKE-PATHNAME :HOST (PATHNAME-HOST OUTPUT-FILE) :TYPE
  ...
  (LET* ((INPUT-FILE
         ...
         (OUTPUT-FILE
          (LET ((OUTPUT-FILE-DEFAULTS
                 (MERGE-PATHNAMES
                  (MAKE-PATHNAME :HOST (PATHNAME-HOST INPUT-FILE) :TYPE "TEX"
                                 :CASE :COMMON)
                  INPUT-FILE)))
            (IF OUTPUT-FILE
         ...
         (INDEX-FILE
          (LET ((INDEX-FILE-DEFAULTS
                 (MERGE-PATHNAMES
                  (MAKE-PATHNAME :HOST (PATHNAME-HOST OUTPUT-FILE) :TYPE "IDX"
                                 :CASE :COMMON)
                  OUTPUT-FILE)))
            (IF INDEX-FILE
         ...
         (SECTIONS-FILE
          (WHEN INDEX-FILE
            (MERGE-PATHNAMES
             (MAKE-PATHNAME :HOST (PATHNAME-HOST INDEX-FILE) :TYPE "SCN" :CASE
                            :COMMON)
             INDEX-FILE))))
