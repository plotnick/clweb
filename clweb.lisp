...
(SET-PPRINT-DISPATCH 'NEWLINE-MARKER
                     (LAMBDA (STREAM OBJ)
                       (DECLARE (IGNORE OBJ))
                       (TERPRI STREAM)))
...
(DEFUN EMPTY-LIST-P (OBJ) (TYPEP OBJ 'EMPTY-LIST-MARKER))
(DEFVAR *EMPTY-LIST* (MAKE-INSTANCE 'EMPTY-LIST-MARKER))
(SET-PPRINT-DISPATCH 'EMPTY-LIST-MARKER
                     (LAMBDA (STREAM OBJ)
...
(DEFUN PRINT-SECTION (STREAM SECTION)
  ...
  (LET* ((COMMENTARY (SECTION-COMMENTARY SECTION))
    ...
    (FRESH-LINE STREAM)
    (WHEN (AND COMMENTARY CODE) (FORMAT STREAM "\\Y~%"))
    (WHEN NAMED-SECTION
