...
(DEFVAR *DEFINING-OPERATORS*
  (LIST (CONS 'DEFUN :FUNCTION) (CONS 'FLET :LOCAL-FUNCTION)
        ...
        (CONS 'DEFVAR :SPECIAL-VARIABLE) (CONS 'DEFPARAMETER :SPECIAL-VARIABLE)
...
(MACROLET ((DEFINE-DEFUN-WALKER (OPERATOR)
             `(DEFINE-SPECIAL-FORM-WALKER ,OPERATOR
                ...
                ,'`(,(CAR FORM)
                    ,@(WALK-LAMBDA-EXPRESSION WALKER (CDR FORM) ENV :DEF
                                              (CAR FORM))))))
...
(DEFINE-SPECIAL-FORM-WALKER DEFMETHOD
  ...
  (MULTIPLE-VALUE-BIND (QUALIFIERS REST)
    ...
    `(,(CAR FORM) ,(WALK-FUNCTION-NAME WALKER (CADR FORM) ENV :DEF (CAR FORM))
      ,@QUALIFIERS ,@REST)))
    ...
    (LOOP
     (LET ((HEADING (PPRINT-POP)))
       (TYPECASE HEADING
         (KEYWORD
          (WRITE-STRING-ESCAPED
           (SUBSTITUTE #\  #\- (STRING-DOWNCASE (SYMBOL-NAME HEADING)))
           STREAM))
