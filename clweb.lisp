...
(DEFUN TANGLE-FILE-PATHNAMES
  ...
  (FLET ((MAKE-TYPE (TYPE)
    ...
    (LET* ((INPUT-FILE (MERGE-PATHNAMES INPUT-FILE (MAKE-TYPE "CLW")))
           (OUTPUT-FILE
            (APPLY #'COMPILE-FILE-PATHNAME INPUT-FILE :ALLOW-OTHER-KEYS T
                   ARGS))
           ...
           (TESTS-OUTPUT-FILE
            (WHEN TESTS-FILE
              (MERGE-PATHNAMES
               (MAKE-PATHNAME :TYPE (PATHNAME-TYPE OUTPUT-FILE)) TESTS-FILE))))
...
(DEFUN WEAVE-PATHNAMES
  ...
  (FLET ((MAKE-TYPE (TYPE)
    ...
    (LET* ((INPUT-FILE (MERGE-PATHNAMES INPUT-FILE (MAKE-TYPE "CLW")))
           ...
           (SECTIONS-FILE
            (WHEN INDEX-FILE (MERGE-PATHNAMES (MAKE-TYPE "SCN") INDEX-FILE))))
